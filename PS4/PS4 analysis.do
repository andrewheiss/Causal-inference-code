...
* Questions 2 and 3
*--------------------
* See http://dl1.cuni.cz/pluginfile.php/101336/mod_resource/content/0/lecture4.pdf for a step-by-step walkthrough of IV
...
* Output everything
outreg2 using Question2.xls, se dec(5) ctitle(2SLS) keep(EDUC) nocons addtext(Year fixed effects, Yes) addstat(Chi-squared, `chi_score', Chi-squared df, `chi_df', F-statistic for instruments, `real_f') append
...
* Output everything
outreg2 using Question2.xls, se dec(5) ctitle(LIML) keep(EDUC) nocons addtext(Year fixed effects, Yes) addstat(Chi-squared, `chi_score', Chi-squared df, `chi_df', F-statistic for instruments, `real_f') append
...
* Output everything
outreg2 using Question5.xls, se dec(5) ctitle(2SLS) keep(hs_grad) nocons addtext(Year fixed effects, Yes) addstat(Chi-squared, `chi_score', Chi-squared df, `chi_df', F-statistic for instruments, `real_f') append
...
* Output everything
outreg2 using Question5.xls, se dec(5) ctitle(LIML) keep(hs_grad) nocons addtext(Year fixed effects, Yes) addstat(Chi-squared, `chi_score', Chi-squared df, `chi_df', F-statistic for instruments, `real_f') append
...
* Output everything
outreg2 using Question6.xls, se dec(5) ctitle(2SLS) keep(college_grad) nocons addtext(Year fixed effects, Yes) addstat(Chi-squared, `chi_score', Chi-squared df, `chi_df', F-statistic for instruments, `real_f') append
...
* Output everything
outreg2 using Question6.xls, se dec(5) ctitle(LIML) keep(college_grad) nocons addtext(Year fixed effects, Yes) addstat(Chi-squared, `chi_score', Chi-squared df, `chi_df', F-statistic for instruments, `real_f') append
